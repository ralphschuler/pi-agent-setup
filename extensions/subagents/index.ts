  ...
  pi.registerTool({
    ...
    parameters: Type.Object({
      ...
      tasks: Type.Optional(Type.Array(Type.Object({
        ...
        output: Type.Optional(Type.Union([Type.String(), Type.Boolean()], { description: "Optional output file." })),
      ...
      output: Type.Optional(Type.Union([Type.String(), Type.Boolean()], { description: "Optional output file for run." })),
      cwd: Type.Optional(Type.String({ description: "Working directory override." })),
    }),
